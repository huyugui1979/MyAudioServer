...
#define COMMON_H
#include "stdafx.h"
enum  PLAYER_EVENT {CHECK_SERVER,TIMER,LOGIN,LOGOUT,CREATE_ROOM,GET_ROOM_LIST,GET_ROOM_MEMBER,JOIN_ROOM,LEAVE_ROOM,AUDIO_DATA,RESET};
enum  PLAYER_STATUS{NOTLOGIN,LOGIN_HALL,JOINED_ROOM};
enum  SEVER_EVENT{CHECK_ECHO,LOGIN_ECHO,LOGOUT_ECHO,MEMBER_JOIN_ROOM_ECHO,MEMBER_LEAVE_ROOM_ECHO,CREATE_ROOM_ECHO,GET_ROOM_LIST_ECHO,GET_ROOM_MEMBER_ECHO,
