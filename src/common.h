...
#define COMMON_H
#include "stdafx.h"
enum  PLAYER_EVENT {CHECK_SERVER,UDP_HOLE,TIMER,LOGIN,LOGOUT,CREATE_ROOM,RECV_AUDIO,SET_TALK_LIST,DESTROY_ROOM,GET_ROOM_LIST,GET_ROOM_MEMBER,JOIN_ROOM,LEAVE_ROOM,AUDIO_DATA,RESET};
...
enum  APP_ERROR{HAVE_LOGIN=100,IDLE_TIME_OUT_ERROR,NOT_LOGIN,HAVE_JOIN_ROOM,NO_JOIN_ROOM,NO_ROOM,ROOM_HAVE_EXIST,ROOM_HAVE_PLAYER,TALK_LIST_NOT_CORRECT};
struct my_execption :
