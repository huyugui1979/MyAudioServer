...
enum  SEVER_EVENT{CHECK_ECHO,LOGIN_ECHO,UDP_HOLE_ECHO,LOGOUT_ECHO,MEMBER_JOIN_ROOM_ECHO,MEMBER_LEAVE_ROOM_ECHO,CREATE_ROOM_ECHO,GET_ROOM_LIST_ECHO,GET_ROOM_MEMBER_ECHO,
                 JOIN_ROOM_ECHO,LEAVE_ROOM_ECHO,AUDIO_DATA_ECHO,SERVER_ERROR_ECHO
                 };
enum  APP_ERROR{HAVE_LOGIN=100,NOT_LOGIN,HAVE_JOIN_ROOM,NO_JOIN_ROOM,NO_ROOM,ROOM_HAVE_EXIST};
struct my_execption :
